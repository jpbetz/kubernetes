...
var map_MutatingAdmissionPolicySpec = map[string]string{
	...
	"mutations":          "mutations contain operations which are used to perform mutations. mutations may not be empty; a minimum of one mutation is required. mutations are evaluated in order, and are reinvoked according to the reinvocationPolicy. The mutations of a policy are invoked for each binding of this policy and reinvocation of mutations occurs on a per binding basis.",
