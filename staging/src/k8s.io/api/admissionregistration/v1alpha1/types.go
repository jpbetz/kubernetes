...
type Mutation struct {
	...
	// Required.
	ReinvocationPolicy ReinvocationPolicyType `json:"reinvocationPolicy,omitempty" protobuf:"bytes,1,opt,name=reinvocationPolicy,casttype=ReinvocationPolicyType"`
...
type JSONPatchOperation struct {
	...
	// Required.
	Op JSONPatchOperationType `json:"op" protobuf:"bytes,1,opt,name=op"`
	...
	// Required.
	PathExpression string `json:"pathExpression" protobuf:"bytes,2,opt,name=pathExpression"`

	// fromExpression will be evaluated by CEL to create a path to a value.
	// from must evaluate to a '/' delimited field path conforming to the [JSON Path spec](https://jsonpatch.com/).
	// Required if the op is "move" or "copy"; must be not be
	// set for other op types.
	FromExpression string `json:"fromExpression,omitempty" protobuf:"bytes,3,opt,name=fromExpression"`
	...
	ValueExpression string `json:"valueExpression,omitempty" protobuf:"bytes,4,opt,name=valueExpression"`
}
