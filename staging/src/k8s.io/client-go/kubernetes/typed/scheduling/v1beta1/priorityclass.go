...
type PriorityClassInterface interface {
	...
	Apply(ctx context.Context, priorityClass schedulingv1beta1.PriorityClassBuilder, fieldManager string, opts v1.ApplyOptions, subresources ...string) (result *v1beta1.PriorityClass, err error)
...
func (c *priorityClasses) Apply(ctx context.Context, priorityClass schedulingv1beta1.PriorityClassBuilder, fieldManager string, opts v1.ApplyOptions, subresources ...string) (result *v1beta1.PriorityClass, err error) {
