...
import (
	...
	schedulingv1alpha1 "k8s.io/client-go/typebuilders/scheduling/v1alpha1"
)
...
func (c *FakePriorityClasses) Apply(ctx context.Context, priorityClass schedulingv1alpha1.PriorityClassBuilder, fieldManager string, opts v1.ApplyOptions, subresources ...string) (result *v1alpha1.PriorityClass, err error) {
