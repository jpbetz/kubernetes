...
func (c *FakeCertificateSigningRequests) Apply(ctx context.Context, certificateSigningRequest typebuilderscertificatesv1.CertificateSigningRequestBuilder, fieldManager string, opts v1.ApplyOptions, subresources ...string) (result *certificatesv1.CertificateSigningRequest, err error) {
