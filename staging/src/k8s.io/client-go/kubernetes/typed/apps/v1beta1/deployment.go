...
type DeploymentInterface interface {
	...
	Apply(ctx context.Context, deployment appsv1beta1.DeploymentBuilder, fieldManager string, opts v1.ApplyOptions, subresources ...string) (result *v1beta1.Deployment, err error)
	DeploymentExpansion
}
...
func (c *deployments) Apply(ctx context.Context, deployment appsv1beta1.DeploymentBuilder, fieldManager string, opts v1.ApplyOptions, subresources ...string) (result *v1beta1.Deployment, err error) {
