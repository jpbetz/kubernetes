...
type ControllerRevisionInterface interface {
	...
	Apply(ctx context.Context, controllerRevision appsv1beta2.ControllerRevisionBuilder, fieldManager string, opts v1.ApplyOptions, subresources ...string) (result *v1beta2.ControllerRevision, err error)
...
func (c *controllerRevisions) Apply(ctx context.Context, controllerRevision appsv1beta2.ControllerRevisionBuilder, fieldManager string, opts v1.ApplyOptions, subresources ...string) (result *v1beta2.ControllerRevision, err error) {
