...
func (c *FakeStatefulSets) Apply(ctx context.Context, statefulSet appsv1beta2.StatefulSetBuilder, fieldManager string, opts v1.ApplyOptions, subresources ...string) (result *v1beta2.StatefulSet, err error) {
