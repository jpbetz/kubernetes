...
func (c *FakeControllerRevisions) Apply(ctx context.Context, controllerRevision appsv1beta2.ControllerRevisionBuilder, fieldManager string, opts v1.ApplyOptions, subresources ...string) (result *v1beta2.ControllerRevision, err error) {
