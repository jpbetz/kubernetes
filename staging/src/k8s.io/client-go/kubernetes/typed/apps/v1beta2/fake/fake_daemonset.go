...
func (c *FakeDaemonSets) Apply(ctx context.Context, daemonSet appsv1beta2.DaemonSetBuilder, fieldManager string, opts v1.ApplyOptions, subresources ...string) (result *v1beta2.DaemonSet, err error) {
