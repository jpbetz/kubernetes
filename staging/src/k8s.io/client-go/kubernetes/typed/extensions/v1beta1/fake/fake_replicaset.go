...
func (c *FakeReplicaSets) Apply(ctx context.Context, replicaSet extensionsv1beta1.ReplicaSetBuilder, fieldManager string, opts v1.ApplyOptions, subresources ...string) (result *v1beta1.ReplicaSet, err error) {
