...
func (c *FakeDeployments) Apply(ctx context.Context, deployment extensionsv1beta1.DeploymentBuilder, fieldManager string, opts v1.ApplyOptions, subresources ...string) (result *v1beta1.Deployment, err error) {
