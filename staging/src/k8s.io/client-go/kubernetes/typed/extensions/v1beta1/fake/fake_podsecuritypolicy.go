...
func (c *FakePodSecurityPolicies) Apply(ctx context.Context, podSecurityPolicy extensionsv1beta1.PodSecurityPolicyBuilder, fieldManager string, opts v1.ApplyOptions, subresources ...string) (result *v1beta1.PodSecurityPolicy, err error) {
