...
func (c *FakeRoles) Apply(ctx context.Context, role rbacv1alpha1.RoleBuilder, fieldManager string, opts v1.ApplyOptions, subresources ...string) (result *v1alpha1.Role, err error) {
