...
type RoleInterface interface {
	...
	Apply(ctx context.Context, role rbacv1alpha1.RoleBuilder, fieldManager string, opts v1.ApplyOptions, subresources ...string) (result *v1alpha1.Role, err error)
	RoleExpansion
}
...
func (c *roles) Apply(ctx context.Context, role rbacv1alpha1.RoleBuilder, fieldManager string, opts v1.ApplyOptions, subresources ...string) (result *v1alpha1.Role, err error) {
