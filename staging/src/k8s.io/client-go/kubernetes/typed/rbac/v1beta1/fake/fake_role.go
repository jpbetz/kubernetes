...
func (c *FakeRoles) Apply(ctx context.Context, role rbacv1beta1.RoleBuilder, fieldManager string, opts v1.ApplyOptions, subresources ...string) (result *v1beta1.Role, err error) {
