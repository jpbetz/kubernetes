...
type ClusterRoleBindingInterface interface {
	...
	Apply(ctx context.Context, clusterRoleBinding *rbacv1beta1.ClusterRoleBindingApplyConfiguration, fieldManager string, opts v1.ApplyOptions, subresources ...string) (result *v1beta1.ClusterRoleBinding, err error)
