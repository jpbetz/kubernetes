...
type ClusterRoleBindingInterface interface {
	...
	Apply(ctx context.Context, clusterRoleBinding rbacv1beta1.ClusterRoleBindingBuilder, fieldManager string, opts v1.ApplyOptions, subresources ...string) (result *v1beta1.ClusterRoleBinding, err error)
...
func (c *clusterRoleBindings) Apply(ctx context.Context, clusterRoleBinding rbacv1beta1.ClusterRoleBindingBuilder, fieldManager string, opts v1.ApplyOptions, subresources ...string) (result *v1beta1.ClusterRoleBinding, err error) {
