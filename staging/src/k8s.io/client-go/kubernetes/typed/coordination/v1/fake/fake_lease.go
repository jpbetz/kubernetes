...
func (c *FakeLeases) Apply(ctx context.Context, lease typebuilderscoordinationv1.LeaseBuilder, fieldManager string, opts v1.ApplyOptions, subresources ...string) (result *coordinationv1.Lease, err error) {
