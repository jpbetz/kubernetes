...
func (c *FakeVolumeAttachments) Apply(ctx context.Context, volumeAttachment storagev1alpha1.VolumeAttachmentBuilder, fieldManager string, opts v1.ApplyOptions, subresources ...string) (result *v1alpha1.VolumeAttachment, err error) {
