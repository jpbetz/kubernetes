...
import (
	...
	storagev1alpha1 "k8s.io/client-go/typebuilders/storage/v1alpha1"
)
...
type VolumeAttachmentInterface interface {
	...
	Apply(ctx context.Context, volumeAttachment storagev1alpha1.VolumeAttachmentBuilder, fieldManager string, opts v1.ApplyOptions, subresources ...string) (result *v1alpha1.VolumeAttachment, err error)
...
func (c *volumeAttachments) Apply(ctx context.Context, volumeAttachment storagev1alpha1.VolumeAttachmentBuilder, fieldManager string, opts v1.ApplyOptions, subresources ...string) (result *v1alpha1.VolumeAttachment, err error) {
