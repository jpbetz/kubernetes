...
func (c *FakeStorageClasses) Apply(ctx context.Context, storageClass storagev1beta1.StorageClassBuilder, fieldManager string, opts v1.ApplyOptions, subresources ...string) (result *v1beta1.StorageClass, err error) {
