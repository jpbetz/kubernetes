...
func (c *FakeValidatingWebhookConfigurations) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ValidatingWebhookConfiguration, err error) {
	obj, err := c.Fake.
...
func (c *FakeValidatingWebhookConfigurations) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ValidatingWebhookConfigurationList, err error) {
	obj, err := c.Fake.
	...
	list := &v1alpha1.ValidatingWebhookConfigurationList{ListMeta: obj.(*v1alpha1.ValidatingWebhookConfigurationList).ListMeta}
...
func (c *FakeValidatingWebhookConfigurations) Create(ctx context.Context, validatingWebhookConfiguration *v1alpha1.ValidatingWebhookConfiguration, opts v1.CreateOptions) (result *v1alpha1.ValidatingWebhookConfiguration, err error) {
	obj, err := c.Fake.
...
func (c *FakeValidatingWebhookConfigurations) Update(ctx context.Context, validatingWebhookConfiguration *v1alpha1.ValidatingWebhookConfiguration, opts v1.UpdateOptions) (result *v1alpha1.ValidatingWebhookConfiguration, err error) {
	obj, err := c.Fake.
...
func (c *FakeValidatingWebhookConfigurations) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewRootDeleteActionWithOptions(validatingwebhookconfigurationsResource, name, opts), &v1alpha1.ValidatingWebhookConfiguration{})
	return err
}
...
func (c *FakeValidatingWebhookConfigurations) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ValidatingWebhookConfiguration, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootPatchSubresourceAction(validatingwebhookconfigurationsResource, name, pt, data, subresources...), &v1alpha1.ValidatingWebhookConfiguration{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.ValidatingWebhookConfiguration), err
...
func (c *FakeValidatingWebhookConfigurations) Apply(ctx context.Context, validatingWebhookConfiguration *admissionregistrationv1alpha1.ValidatingWebhookConfigurationApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.ValidatingWebhookConfiguration, err error) {
	...
	obj, err := c.Fake.
		Invokes(testing.NewRootPatchSubresourceAction(validatingwebhookconfigurationsResource, *name, types.ApplyPatchType, data), &v1alpha1.ValidatingWebhookConfiguration{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.ValidatingWebhookConfiguration), err
