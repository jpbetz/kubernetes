...
type PolicyBindingInterface interface {
	...
	Apply(ctx context.Context, policyBinding *admissionregistrationv1alpha1.PolicyBindingApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.PolicyBinding, err error)
...
func newPolicyBindings(c *AdmissionregistrationV1alpha1Client) *policyBindings {
...
func (c *policyBindings) Apply(ctx context.Context, policyBinding *admissionregistrationv1alpha1.PolicyBindingApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.PolicyBinding, err error) {
