...
func (c *FakeMutatingWebhookConfigurations) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.MutatingWebhookConfiguration, err error) {
	obj, err := c.Fake.
...
func (c *FakeMutatingWebhookConfigurations) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.MutatingWebhookConfigurationList, err error) {
	obj, err := c.Fake.
	...
	list := &v1alpha1.MutatingWebhookConfigurationList{ListMeta: obj.(*v1alpha1.MutatingWebhookConfigurationList).ListMeta}
...
func (c *FakeMutatingWebhookConfigurations) Create(ctx context.Context, mutatingWebhookConfiguration *v1alpha1.MutatingWebhookConfiguration, opts v1.CreateOptions) (result *v1alpha1.MutatingWebhookConfiguration, err error) {
	obj, err := c.Fake.
...
func (c *FakeMutatingWebhookConfigurations) Update(ctx context.Context, mutatingWebhookConfiguration *v1alpha1.MutatingWebhookConfiguration, opts v1.UpdateOptions) (result *v1alpha1.MutatingWebhookConfiguration, err error) {
	obj, err := c.Fake.
...
func (c *FakeMutatingWebhookConfigurations) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewRootDeleteActionWithOptions(mutatingwebhookconfigurationsResource, name, opts), &v1alpha1.MutatingWebhookConfiguration{})
	return err
}
...
func (c *FakeMutatingWebhookConfigurations) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.MutatingWebhookConfiguration, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootPatchSubresourceAction(mutatingwebhookconfigurationsResource, name, pt, data, subresources...), &v1alpha1.MutatingWebhookConfiguration{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.MutatingWebhookConfiguration), err
...
func (c *FakeMutatingWebhookConfigurations) Apply(ctx context.Context, mutatingWebhookConfiguration *admissionregistrationv1alpha1.MutatingWebhookConfigurationApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.MutatingWebhookConfiguration, err error) {
	...
	obj, err := c.Fake.
		Invokes(testing.NewRootPatchSubresourceAction(mutatingwebhookconfigurationsResource, *name, types.ApplyPatchType, data), &v1alpha1.MutatingWebhookConfiguration{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.MutatingWebhookConfiguration), err
