...
type ValidatingWebhookConfigurationInterface interface {
	Create(ctx context.Context, validatingWebhookConfiguration *v1alpha1.ValidatingWebhookConfiguration, opts v1.CreateOptions) (*v1alpha1.ValidatingWebhookConfiguration, error)
	Update(ctx context.Context, validatingWebhookConfiguration *v1alpha1.ValidatingWebhookConfiguration, opts v1.UpdateOptions) (*v1alpha1.ValidatingWebhookConfiguration, error)
	Delete(ctx context.Context, name string, opts v1.DeleteOptions) error
	DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error
	Get(ctx context.Context, name string, opts v1.GetOptions) (*v1alpha1.ValidatingWebhookConfiguration, error)
	List(ctx context.Context, opts v1.ListOptions) (*v1alpha1.ValidatingWebhookConfigurationList, error)
	Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error)
	Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ValidatingWebhookConfiguration, err error)
	Apply(ctx context.Context, validatingWebhookConfiguration *admissionregistrationv1alpha1.ValidatingWebhookConfigurationApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.ValidatingWebhookConfiguration, err error)
...
func (c *validatingWebhookConfigurations) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ValidatingWebhookConfiguration, err error) {
...
func (c *validatingWebhookConfigurations) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ValidatingWebhookConfigurationList, err error) {
...
func (c *validatingWebhookConfigurations) Create(ctx context.Context, validatingWebhookConfiguration *v1alpha1.ValidatingWebhookConfiguration, opts v1.CreateOptions) (result *v1alpha1.ValidatingWebhookConfiguration, err error) {
	result = &v1alpha1.ValidatingWebhookConfiguration{}
	err = c.client.Post().
		Resource("validatingwebhookconfigurations").
		VersionedParams(&opts, scheme.ParameterCodec).
...
func (c *validatingWebhookConfigurations) Update(ctx context.Context, validatingWebhookConfiguration *v1alpha1.ValidatingWebhookConfiguration, opts v1.UpdateOptions) (result *v1alpha1.ValidatingWebhookConfiguration, err error) {
	result = &v1alpha1.ValidatingWebhookConfiguration{}
	err = c.client.Put().
		Resource("validatingwebhookconfigurations").
...
func (c *validatingWebhookConfigurations) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ValidatingWebhookConfiguration, err error) {
	result = &v1alpha1.ValidatingWebhookConfiguration{}
...
func (c *validatingWebhookConfigurations) Apply(ctx context.Context, validatingWebhookConfiguration *admissionregistrationv1alpha1.ValidatingWebhookConfigurationApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.ValidatingWebhookConfiguration, err error) {
