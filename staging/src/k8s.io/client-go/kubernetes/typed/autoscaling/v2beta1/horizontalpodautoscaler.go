...
type HorizontalPodAutoscalerInterface interface {
	...
	Apply(ctx context.Context, horizontalPodAutoscaler autoscalingv2beta1.HorizontalPodAutoscalerBuilder, fieldManager string, opts v1.ApplyOptions, subresources ...string) (result *v2beta1.HorizontalPodAutoscaler, err error)
...
func (c *horizontalPodAutoscalers) Apply(ctx context.Context, horizontalPodAutoscaler autoscalingv2beta1.HorizontalPodAutoscalerBuilder, fieldManager string, opts v1.ApplyOptions, subresources ...string) (result *v2beta1.HorizontalPodAutoscaler, err error) {
