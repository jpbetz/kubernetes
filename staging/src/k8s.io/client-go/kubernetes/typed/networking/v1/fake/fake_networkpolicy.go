...
func (c *FakeNetworkPolicies) Apply(ctx context.Context, networkPolicy typebuildersnetworkingv1.NetworkPolicyBuilder, fieldManager string, opts v1.ApplyOptions, subresources ...string) (result *networkingv1.NetworkPolicy, err error) {
