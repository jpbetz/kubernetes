...
func (c *FakeRuntimeClasses) Apply(ctx context.Context, runtimeClass nodev1beta1.RuntimeClassBuilder, fieldManager string, opts v1.ApplyOptions, subresources ...string) (result *v1beta1.RuntimeClass, err error) {
