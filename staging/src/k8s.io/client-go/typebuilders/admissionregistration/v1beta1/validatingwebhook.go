...
type validatingWebhookFields struct {
	...
	ObjectSelector          *v1.LabelSelectorBuilder                        `json:"objectSelector,omitempty"`
...
func (b *ValidatingWebhookBuilder) SetFailurePolicy(value admissionregistrationv1beta1.FailurePolicyType) *ValidatingWebhookBuilder {
...
func (b *ValidatingWebhookBuilder) GetFailurePolicy() (value admissionregistrationv1beta1.FailurePolicyType, ok bool) {
...
func (b *ValidatingWebhookBuilder) SetMatchPolicy(value admissionregistrationv1beta1.MatchPolicyType) *ValidatingWebhookBuilder {
...
func (b *ValidatingWebhookBuilder) GetMatchPolicy() (value admissionregistrationv1beta1.MatchPolicyType, ok bool) {
...
func (b *ValidatingWebhookBuilder) SetNamespaceSelector(value *v1.LabelSelectorBuilder) *ValidatingWebhookBuilder {
...
func (b *ValidatingWebhookBuilder) GetNamespaceSelector() (value *v1.LabelSelectorBuilder, ok bool) {
...
func (b *ValidatingWebhookBuilder) SetObjectSelector(value *v1.LabelSelectorBuilder) *ValidatingWebhookBuilder {
...
func (b *ValidatingWebhookBuilder) GetObjectSelector() (value *v1.LabelSelectorBuilder, ok bool) {
...
func (b *ValidatingWebhookBuilder) SetSideEffects(value admissionregistrationv1beta1.SideEffectClass) *ValidatingWebhookBuilder {
...
func (b *ValidatingWebhookBuilder) GetSideEffects() (value admissionregistrationv1beta1.SideEffectClass, ok bool) {
