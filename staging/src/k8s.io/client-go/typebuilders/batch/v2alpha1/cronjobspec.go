...
func (b CronJobSpecBuilder) SetConcurrencyPolicy(value v2alpha1.ConcurrencyPolicy) CronJobSpecBuilder {
	b.ensureInitialized()
...
func (b CronJobSpecBuilder) GetConcurrencyPolicy() (value v2alpha1.ConcurrencyPolicy, ok bool) {
	b.ensureInitialized()
