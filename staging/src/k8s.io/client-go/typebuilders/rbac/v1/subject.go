...
func (b SubjectBuilder) SetAPIGroup(value string) SubjectBuilder {
	b.ensureInitialized()
...
func (b SubjectBuilder) RemoveAPIGroup() SubjectBuilder {
	b.ensureInitialized()
...
func (b SubjectBuilder) GetAPIGroup() (value string, ok bool) {
	b.ensureInitialized()
