...
func (b ReplicaSetConditionBuilder) SetType(value v1beta1.ReplicaSetConditionType) ReplicaSetConditionBuilder {
	b.ensureInitialized()
	b.fields.Type = &value
	return b
}
...
func (b ReplicaSetConditionBuilder) GetType() (value v1beta1.ReplicaSetConditionType, ok bool) {
	b.ensureInitialized()
