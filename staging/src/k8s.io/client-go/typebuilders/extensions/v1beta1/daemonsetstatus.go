...
// daemonSetStatusFields is used by DaemonSetStatusBuilder for json marshalling and unmarshalling.
// Is the source-of-truth for all fields except inlined fields.
// Inline fields are copied in from their builder type in DaemonSetStatusBuilder before marshalling, and
// are copied out to the builder type in DaemonSetStatusBuilder after unmarshalling.
...
func (b *DaemonSetStatusBuilder) ensureInitialized() {
	if b.fields == nil {
		b.fields = &daemonSetStatusFields{}
	}
}
...
func DaemonSetStatus() DaemonSetStatusBuilder {
	return DaemonSetStatusBuilder{fields: &daemonSetStatusFields{}}
}
