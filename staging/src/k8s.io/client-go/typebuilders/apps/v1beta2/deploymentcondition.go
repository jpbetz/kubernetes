...
func (b DeploymentConditionBuilder) SetType(value v1beta2.DeploymentConditionType) DeploymentConditionBuilder {
	b.ensureInitialized()
	b.fields.Type = &value
	return b
}
...
func (b DeploymentConditionBuilder) GetType() (value v1beta2.DeploymentConditionType, ok bool) {
	b.ensureInitialized()
