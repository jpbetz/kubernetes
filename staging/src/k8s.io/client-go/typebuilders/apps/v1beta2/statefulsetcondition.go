...
func (b *StatefulSetConditionBuilder) SetType(value v1beta2.StatefulSetConditionType) *StatefulSetConditionBuilder {
	b.fields.Type = &value
	return b
}
...
func (b *StatefulSetConditionBuilder) GetType() (value v1beta2.StatefulSetConditionType, ok bool) {
