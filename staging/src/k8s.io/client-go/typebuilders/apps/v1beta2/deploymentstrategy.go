...
func (b DeploymentStrategyBuilder) SetType(value v1beta2.DeploymentStrategyType) DeploymentStrategyBuilder {
	b.ensureInitialized()
	b.fields.Type = &value
	return b
}
...
func (b DeploymentStrategyBuilder) GetType() (value v1beta2.DeploymentStrategyType, ok bool) {
	b.ensureInitialized()
