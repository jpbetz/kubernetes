...
func (b StatefulSetUpdateStrategyBuilder) SetType(value v1.StatefulSetUpdateStrategyType) StatefulSetUpdateStrategyBuilder {
	b.ensureInitialized()
	b.fields.Type = &value
	return b
}
...
func (b StatefulSetUpdateStrategyBuilder) GetType() (value v1.StatefulSetUpdateStrategyType, ok bool) {
	b.ensureInitialized()
