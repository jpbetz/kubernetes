...
func (b StatefulSetSpecBuilder) SetPodManagementPolicy(value appsv1.PodManagementPolicyType) StatefulSetSpecBuilder {
	b.ensureInitialized()
...
func (b StatefulSetSpecBuilder) GetPodManagementPolicy() (value appsv1.PodManagementPolicyType, ok bool) {
	b.ensureInitialized()
