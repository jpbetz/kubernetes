...
type ValidationApplyConfiguration struct {
	...
	MessageExpression *string `json:"expressMessage,omitempty"`
...
func (b *ValidationApplyConfiguration) WithName(value string) *ValidationApplyConfiguration {
	b.Name = &value
	return b
}
...
func (b *ValidationApplyConfiguration) WithReason(value string) *ValidationApplyConfiguration {
	b.Reason = &value
	return b
}
...
func (b *ValidationApplyConfiguration) WithCode(value string) *ValidationApplyConfiguration {
	b.Code = &value
	return b
}
