...
type MutationApplyConfiguration struct {
	...
	JSONPatch          *admissionregistrationv1alpha1.JSONPatch `json:"jsonPatch,omitempty"`
}
...
func (b *MutationApplyConfiguration) WithReinvocationPolicy(value v1.ReinvocationPolicyType) *MutationApplyConfiguration {
...
func (b *MutationApplyConfiguration) WithJSONPatch(value admissionregistrationv1alpha1.JSONPatch) *MutationApplyConfiguration {
	b.JSONPatch = &value
	return b
}
