...
// apply.
func PolicyBinding(name string) *PolicyBindingApplyConfiguration {
...
// ExtractPolicyBinding extracts the applied configuration owned by fieldManager from
// policyBinding. If no managedFields are found in policyBinding for fieldManager, a
// PolicyBindingApplyConfiguration is returned with only the Name, Namespace (if applicable),
// APIVersion and Kind populated. It is possible that no managed fields were found for because other
// field managers have taken ownership of all the fields previously owned by fieldManager, or because
// the fieldManager never owned fields any fields.
// policyBinding must be a unmodified PolicyBinding API object that was retrieved from the Kubernetes API.
// ExtractPolicyBinding provides a way to perform a extract/modify-in-place/apply workflow.
// Note that an extracted apply configuration will contain fewer fields than what the fieldManager previously
// applied if another fieldManager has updated or force applied any of the previously applied fields.
// Experimental!
func ExtractPolicyBinding(policyBinding *admissionregistrationv1alpha1.PolicyBinding, fieldManager string) (*PolicyBindingApplyConfiguration, error) {
	return extractPolicyBinding(policyBinding, fieldManager, "")
}

// ExtractPolicyBindingStatus is the same as ExtractPolicyBinding except
// that it extracts the status subresource applied configuration.
// Experimental!
func ExtractPolicyBindingStatus(policyBinding *admissionregistrationv1alpha1.PolicyBinding, fieldManager string) (*PolicyBindingApplyConfiguration, error) {
	return extractPolicyBinding(policyBinding, fieldManager, "status")
}

func extractPolicyBinding(policyBinding *admissionregistrationv1alpha1.PolicyBinding, fieldManager string, subresource string) (*PolicyBindingApplyConfiguration, error) {
	b := &PolicyBindingApplyConfiguration{}
	err := managedfields.ExtractInto(policyBinding, internal.Parser().Type("io.k8s.api.admissionregistration.v1alpha1.PolicyBinding"), fieldManager, b, subresource)
	if err != nil {
		return nil, err
	}
	b.WithName(policyBinding.Name)
