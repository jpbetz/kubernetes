...
type ruleWithOperationsFields struct {
	...
	Scope       *admissionregistrationv1.ScopeType       `json:"scope,omitempty"`       // inlined RuleWithOperationsApplyConfiguration.rule.Scope field
}

// SetOperations sets the Operations field in the declarative configuration to the given value.
func (b *RuleWithOperationsApplyConfiguration) SetOperations(value []admissionregistrationv1.OperationType) *RuleWithOperationsApplyConfiguration {
...
func (b *RuleWithOperationsApplyConfiguration) GetOperations() (value []admissionregistrationv1.OperationType, ok bool) {
