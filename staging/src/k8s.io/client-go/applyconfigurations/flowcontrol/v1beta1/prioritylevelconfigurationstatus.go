...
func (b *PriorityLevelConfigurationStatusApplyConfiguration) SetConditions(value []PriorityLevelConfigurationConditionApplyConfiguration) *PriorityLevelConfigurationStatusApplyConfiguration {
	b.Conditions = &value
	return b
}
