...
func ClusterRoleBinding(name string) *ClusterRoleBindingApplyConfiguration {
	...
	b.SetName(name)
	b.SetKind("ClusterRoleBinding")
	b.SetAPIVersion("rbac/v1alpha1")
	return b
}

// SetSubjects sets the Subjects field in the declarative configuration to the given value.
func (b *ClusterRoleBindingApplyConfiguration) SetSubjects(value []SubjectApplyConfiguration) *ClusterRoleBindingApplyConfiguration {
	b.Subjects = &value
	return b
}
