...
func (b *StorageVersionStatusApplyConfiguration) SetStorageVersions(value []ServerStorageVersionApplyConfiguration) *StorageVersionStatusApplyConfiguration {
...
func (b *StorageVersionStatusApplyConfiguration) SetConditions(value []StorageVersionConditionApplyConfiguration) *StorageVersionStatusApplyConfiguration {
	b.Conditions = &value
	return b
}
