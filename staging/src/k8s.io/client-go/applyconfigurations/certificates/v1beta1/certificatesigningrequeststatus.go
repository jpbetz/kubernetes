...
func (b *CertificateSigningRequestStatusApplyConfiguration) SetConditions(value []CertificateSigningRequestConditionApplyConfiguration) *CertificateSigningRequestStatusApplyConfiguration {
	b.Conditions = &value
	return b
}
