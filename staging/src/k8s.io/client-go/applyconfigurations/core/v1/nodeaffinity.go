...
func (b *NodeAffinityApplyConfiguration) SetPreferredDuringSchedulingIgnoredDuringExecution(value []PreferredSchedulingTermApplyConfiguration) *NodeAffinityApplyConfiguration {
