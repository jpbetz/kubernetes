...
func (b *NodeSelectorTermApplyConfiguration) SetMatchExpressions(value []NodeSelectorRequirementApplyConfiguration) *NodeSelectorTermApplyConfiguration {
	b.MatchExpressions = &value
	return b
}

// SetMatchFields sets the MatchFields field in the declarative configuration to the given value.
func (b *NodeSelectorTermApplyConfiguration) SetMatchFields(value []NodeSelectorRequirementApplyConfiguration) *NodeSelectorTermApplyConfiguration {
	b.MatchFields = &value
	return b
}
