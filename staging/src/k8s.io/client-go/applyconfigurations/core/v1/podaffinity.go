...
func (b *PodAffinityApplyConfiguration) SetRequiredDuringSchedulingIgnoredDuringExecution(value []PodAffinityTermApplyConfiguration) *PodAffinityApplyConfiguration {
...
func (b *PodAffinityApplyConfiguration) SetPreferredDuringSchedulingIgnoredDuringExecution(value []WeightedPodAffinityTermApplyConfiguration) *PodAffinityApplyConfiguration {
