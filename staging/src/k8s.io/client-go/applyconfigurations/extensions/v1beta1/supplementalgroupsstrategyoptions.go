...
func (b *SupplementalGroupsStrategyOptionsApplyConfiguration) SetRanges(value []IDRangeApplyConfiguration) *SupplementalGroupsStrategyOptionsApplyConfiguration {
	b.Ranges = &value
	return b
}
