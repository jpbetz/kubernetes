...
func (b *NetworkPolicyIngressRuleApplyConfiguration) SetPorts(value []NetworkPolicyPortApplyConfiguration) *NetworkPolicyIngressRuleApplyConfiguration {
	b.Ports = &value
	return b
}

// SetFrom sets the From field in the declarative configuration to the given value.
func (b *NetworkPolicyIngressRuleApplyConfiguration) SetFrom(value []NetworkPolicyPeerApplyConfiguration) *NetworkPolicyIngressRuleApplyConfiguration {
	b.From = &value
	return b
}
