...
func (b *NetworkPolicySpecApplyConfiguration) SetIngress(value []NetworkPolicyIngressRuleApplyConfiguration) *NetworkPolicySpecApplyConfiguration {
	b.Ingress = &value
	return b
}

// SetEgress sets the Egress field in the declarative configuration to the given value.
func (b *NetworkPolicySpecApplyConfiguration) SetEgress(value []NetworkPolicyEgressRuleApplyConfiguration) *NetworkPolicySpecApplyConfiguration {
	b.Egress = &value
	return b
}
