...
func NewExtensionValidator(resolver resolver.SchemaResolver) *ExtensionValidator {
	return &ExtensionValidator{resolver: resolver}
}

func (ev *ExtensionValidator) Validate(ctx context.Context, fldPath *field.Path, gvk schema.GroupVersionKind, obj map[string]interface{}) (errs field.ErrorList) {
	u := unstructured.Unstructured{Object: obj}
	embeddedSchema, err := ev.resolver.ResolveSchema(gvk)
	if err != nil {
...
func (ev *ExtensionValidator) ValidateUpdate(ctx context.Context, fldPath *field.Path, gvk schema.GroupVersionKind, obj, oldObj map[string]interface{}) (errs field.ErrorList) {
	u := unstructured.Unstructured{Object: obj}
