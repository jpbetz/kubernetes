...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ExtensionMeta) DeepCopyInto(out *ExtensionMeta) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ExtensionMeta.
func (in *ExtensionMeta) DeepCopy() *ExtensionMeta {
	if in == nil {
		return nil
	}
	out := new(ExtensionMeta)
	in.DeepCopyInto(out)
	return out
}
