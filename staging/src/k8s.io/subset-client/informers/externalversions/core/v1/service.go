...
import (
	...
	corev1 "k8s.io/subset-client/listers/core/v1"
	subsettypescorev1 "k8s.io/subset-types/core/v1"
)
...
func (f *serviceInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&subsettypescorev1.Service{}, f.defaultInformer)
}
