...
import (
	...
	versioned "k8s.io/subset-client/clientset/versioned"
	internalinterfaces "k8s.io/subset-client/informers/externalversions/internalinterfaces"
	appsv1 "k8s.io/subset-client/listers/apps/v1"
	subsettypesappsv1 "k8s.io/subset-types/apps/v1"
)
...
func (f *replicaSetInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&subsettypesappsv1.ReplicaSet{}, f.defaultInformer)
}
