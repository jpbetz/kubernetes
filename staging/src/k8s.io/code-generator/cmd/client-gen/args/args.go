...
type CustomArgs struct {
	...
	// ApplyBuilderPackage is the package of apply builders generated by typebuilder-gen.
...
func (ca *CustomArgs) AddFlags(fs *pflag.FlagSet, inputBase string) {
	...
	fs.StringVar(&ca.ApplyBuilderPackage, "applybuilder-package", ca.ApplyBuilderPackage, "optional package of apply builders, generated by typebuilder-gen, that are required to generate Apply functions for each type in the clientset. By default Apply functions are not generated.")
