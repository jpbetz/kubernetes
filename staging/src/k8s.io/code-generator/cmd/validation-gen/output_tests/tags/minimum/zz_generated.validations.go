...
func Validate_IntType(ctx context.Context, op operation.Operation, fldPath *field.Path, obj, oldObj *IntType, v *visit.State) (errs field.ErrorList) {
	// type IntType
...
func Validate_Struct(ctx context.Context, op operation.Operation, fldPath *field.Path, obj, oldObj *Struct, v *visit.State) (errs field.ErrorList) {
	...
	errs = append(errs,
		visit.Leaf(op, v, func(fldPath *field.Path, obj, oldObj *int) (errs field.ErrorList) {
			errs = append(errs, validate.Minimum(ctx, op, fldPath, obj, oldObj, 1)...)
			return
	...
	errs = append(errs,
		visit.Leaf(op, v, func(fldPath *field.Path, obj, oldObj *int16) (errs field.ErrorList) {
			errs = append(errs, validate.Minimum(ctx, op, fldPath, obj, oldObj, 1)...)
			return
	...
	errs = append(errs,
		visit.Leaf(op, v, func(fldPath *field.Path, obj, oldObj *int64) (errs field.ErrorList) {
			errs = append(errs, validate.Minimum(ctx, op, fldPath, obj, oldObj, 1)...)
			return
	...
	errs = append(errs,
		visit.Leaf(op, v, func(fldPath *field.Path, obj, oldObj *uint) (errs field.ErrorList) {
			errs = append(errs, validate.Minimum(ctx, op, fldPath, obj, oldObj, 1)...)
			return
	...
	errs = append(errs,
		visit.Leaf(op, v, func(fldPath *field.Path, obj, oldObj *uint16) (errs field.ErrorList) {
			errs = append(errs, validate.Minimum(ctx, op, fldPath, obj, oldObj, 1)...)
			return
	...
	errs = append(errs,
		visit.Leaf(op, v, func(fldPath *field.Path, obj, oldObj *uint32) (errs field.ErrorList) {
			errs = append(errs, validate.Minimum(ctx, op, fldPath, obj, oldObj, 1)...)
			return
	...
	errs = append(errs,
		visit.Leaf(op, v, func(fldPath *field.Path, obj, oldObj *uint64) (errs field.ErrorList) {
			errs = append(errs, validate.Minimum(ctx, op, fldPath, obj, oldObj, 1)...)
			return
	...
	errs = append(errs,
		visit.Leaf(op, v, func(fldPath *field.Path, obj, oldObj *IntType) (errs field.ErrorList) {
			errs = append(errs, validate.Minimum(ctx, op, fldPath, obj, oldObj, 1)...)
			errs = append(errs, Validate_IntType(ctx, op, fldPath, obj, oldObj, v)...)
			return
