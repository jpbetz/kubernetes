...
func Test(t *testing.T) {
	...
	st.Value(&Struct{
		...
		SliceOfStructPtrField:             []*OtherStruct{&OtherStruct{}, &OtherStruct{}},
		SliceOfOpaqueStructField:          []OtherStruct{{}, {}},
		SliceOfOpaqueStructPtrField:       []*OtherStruct{&OtherStruct{}, &OtherStruct{}},
		ListMapOfStructField:              []OtherStruct{{"foo"}, {"bar"}},
		ListMapOfStructPtrField:           []*OtherStruct{&OtherStruct{"foo"}, &OtherStruct{"bar"}},
		ListMapOfOpaqueStructField:        []OtherStruct{{"foo"}, {"bar"}},
		ListMapOfOpaqueStructPtrField:     []*OtherStruct{&OtherStruct{"foo"}, &OtherStruct{"bar"}},
		MapOfStringToStructField:          map[OtherString]OtherStruct{"a": {"foo"}, "b": {"bar"}},
		MapOfStringToStructPtrField:       map[OtherString]*OtherStruct{"a": &OtherStruct{"foo"}, "b": &OtherStruct{"bar"}},
		MapOfStringToOpaqueStructField:    map[OtherString]OtherStruct{"a": {"foo"}, "b": {"bar"}},
		MapOfStringToOpaqueStructPtrField: map[OtherString]*OtherStruct{"a": &OtherStruct{"foo"}, "b": &OtherStruct{"bar"}},
