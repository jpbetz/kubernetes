...
func Validate_Max0Type(ctx context.Context, op operation.Operation, fldPath *field.Path, obj, oldObj Max0Type, v *visit.State) (errs field.ErrorList) {
	// type Max0Type
...
func Validate_Max0TypedefType(ctx context.Context, op operation.Operation, fldPath *field.Path, obj, oldObj Max0TypedefType, v *visit.State) (errs field.ErrorList) {
...
func Validate_Max10Type(ctx context.Context, op operation.Operation, fldPath *field.Path, obj, oldObj Max10Type, v *visit.State) (errs field.ErrorList) {
	// type Max10Type
...
func Validate_Max10TypedefType(ctx context.Context, op operation.Operation, fldPath *field.Path, obj, oldObj Max10TypedefType, v *visit.State) (errs field.ErrorList) {
...
func Validate_Struct(ctx context.Context, op operation.Operation, fldPath *field.Path, obj, oldObj *Struct, v *visit.State) (errs field.ErrorList) {
	...
	errs = append(errs,
		visit.Leaf(op, v, func(fldPath *field.Path, obj, oldObj Max0Type) (errs field.ErrorList) {
			errs = append(errs, Validate_Max0Type(ctx, op, fldPath, obj, oldObj, v)...)
			return
	...
	errs = append(errs,
		visit.Leaf(op, v, func(fldPath *field.Path, obj, oldObj Max10Type) (errs field.ErrorList) {
			errs = append(errs, Validate_Max10Type(ctx, op, fldPath, obj, oldObj, v)...)
			return
	...
	errs = append(errs,
		visit.Leaf(op, v, func(fldPath *field.Path, obj, oldObj Max0TypedefType) (errs field.ErrorList) {
			errs = append(errs, Validate_Max0TypedefType(ctx, op, fldPath, obj, oldObj, v)...)
			return
	...
	errs = append(errs,
		visit.Leaf(op, v, func(fldPath *field.Path, obj, oldObj Max10TypedefType) (errs field.ErrorList) {
			errs = append(errs, Validate_Max10TypedefType(ctx, op, fldPath, obj, oldObj, v)...)
			return
