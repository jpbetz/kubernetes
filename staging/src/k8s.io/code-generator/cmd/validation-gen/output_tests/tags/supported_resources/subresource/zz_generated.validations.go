...
var (
	t1SupportedResources = []operation.ResourcePattern{operation.MustParsePattern("test"), operation.MustParsePattern("test/scale"), operation.MustParsePattern("test/status"), operation.MustParsePattern("test/x/y")}
)
