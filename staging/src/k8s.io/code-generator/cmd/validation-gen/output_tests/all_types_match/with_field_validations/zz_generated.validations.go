...
func Validate_T3(opCtx operation.Context, obj *T3, fldPath *field.Path) (errs field.ErrorList) {
	// field T3.S has no validation
	return errs
}

func Validate_T4(opCtx operation.Context, obj *T4, fldPath *field.Path) (errs field.ErrorList) {
	// field T4.S
	errs = append(errs,
		func(obj string, fldPath *field.Path) (errs field.ErrorList) {
...
func Validate_T5(opCtx operation.Context, obj *T5, fldPath *field.Path) (errs field.ErrorList) {
