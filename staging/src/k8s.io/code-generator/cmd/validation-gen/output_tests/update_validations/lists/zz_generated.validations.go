...
func Validate_T1(ctx context.Context, op operation.Operation, fldPath *field.Path, obj, oldObj *T1, v *visit.State) (errs field.ErrorList) {
	...
	errs = append(errs,
		visit.Leaf(op, v, func(fldPath *field.Path, obj, oldObj []M1) (errs field.ErrorList) {
			errs = append(errs, validate.EachSliceVal(ctx, op, fldPath, obj, oldObj, nil, func(ctx context.Context, op operation.Operation, fldPath *field.Path, obj, oldObj *M1) field.ErrorList {
