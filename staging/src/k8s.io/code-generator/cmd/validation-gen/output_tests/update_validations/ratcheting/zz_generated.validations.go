...
func Validate_Struct(ctx context.Context, op operation.Operation, fldPath *field.Path, obj, oldObj *Struct, v *visit.State) (errs field.ErrorList) {
	// field Struct.SP
	errs = append(errs,
		visit.Leaf(v, func(fldPath *field.Path, obj, oldObj *string) (errs field.ErrorList) {
			errs = append(errs, validate.FixedResult(ctx, op, fldPath, obj, oldObj, false, "Struct.SP")...)
			return
		})(fldPath.Child("sp"), obj.SP, safe.Field(oldObj, func(oldObj *Struct) *string { return oldObj.SP }))...)

	// field Struct.IP
	errs = append(errs,
		visit.Leaf(v, func(fldPath *field.Path, obj, oldObj *int) (errs field.ErrorList) {
			errs = append(errs, validate.FixedResult(ctx, op, fldPath, obj, oldObj, false, "Struct.IP")...)
			return
		})(fldPath.Child("ip"), obj.IP, safe.Field(oldObj, func(oldObj *Struct) *int { return oldObj.IP }))...)

	// field Struct.BP
	errs = append(errs,
		visit.Leaf(v, func(fldPath *field.Path, obj, oldObj *bool) (errs field.ErrorList) {
			errs = append(errs, validate.FixedResult(ctx, op, fldPath, obj, oldObj, false, "Struct.BP")...)
			return
		})(fldPath.Child("bp"), obj.BP, safe.Field(oldObj, func(oldObj *Struct) *bool { return oldObj.BP }))...)

	// field Struct.FP
	errs = append(errs,
		visit.Leaf(v, func(fldPath *field.Path, obj, oldObj *float64) (errs field.ErrorList) {
			errs = append(errs, validate.FixedResult(ctx, op, fldPath, obj, oldObj, false, "Struct.FP")...)
			return
