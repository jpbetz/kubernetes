...
func Validate_T1(ctx context.Context, op operation.Operation, fldPath *field.Path, obj, oldObj *T1, v *visit.State) (errs field.ErrorList) {
	...
	errs = append(errs,
		visit.Child(op, v, func(fldPath *field.Path, obj, oldObj *primitives.T1) (errs field.ErrorList) {
			errs = append(errs, validate.FixedResult(ctx, op, fldPath, obj, oldObj, true, "field T1.PrimitivesT1")...)
			errs = append(errs, primitives.Validate_T1(ctx, op, fldPath, obj, oldObj, v)...)
			return
	...
	errs = append(errs,
		visit.Child(op, v, func(fldPath *field.Path, obj, oldObj *primitives.T2) (errs field.ErrorList) {
			errs = append(errs, validate.FixedResult(ctx, op, fldPath, obj, oldObj, true, "field T1.PrimitivesT2")...)
			errs = append(errs, primitives.Validate_T2(ctx, op, fldPath, obj, oldObj, v)...)
			return
	...
	errs = append(errs,
		visit.Child(op, v, func(fldPath *field.Path, obj, oldObj *primitives.T3) (errs field.ErrorList) {
	...
	// field T1.TypedefsE1
	errs = append(errs,
		visit.Leaf(op, v, func(fldPath *field.Path, obj, oldObj *typedefs.E1) (errs field.ErrorList) {
			errs = append(errs, validate.FixedResult(ctx, op, fldPath, obj, oldObj, true, "field T1.TypedefsE1")...)
			errs = append(errs, typedefs.Validate_E1(ctx, op, fldPath, obj, oldObj, v)...)
			return
	...
	// field T1.TypedefsE2
	errs = append(errs,
		visit.Leaf(op, v, func(fldPath *field.Path, obj, oldObj *typedefs.E2) (errs field.ErrorList) {
			errs = append(errs, validate.FixedResult(ctx, op, fldPath, obj, oldObj, true, "field T1.TypedefsE2")...)
			errs = append(errs, typedefs.Validate_E2(ctx, op, fldPath, obj, oldObj, v)...)
			return
	...
	// field T1.TypedefsE3
	errs = append(errs,
		visit.Leaf(op, v, func(fldPath *field.Path, obj, oldObj *typedefs.E3) (errs field.ErrorList) {
			errs = append(errs, validate.FixedResult(ctx, op, fldPath, obj, oldObj, true, "field T1.TypedefsE3")...)
			errs = append(errs, typedefs.Validate_E3(ctx, op, fldPath, obj, oldObj, v)...)
			return
	...
	// field T1.TypedefsE4
	errs = append(errs,
		visit.Child(op, v, func(fldPath *field.Path, obj, oldObj *typedefs.E4) (errs field.ErrorList) {
			errs = append(errs, validate.FixedResult(ctx, op, fldPath, obj, oldObj, true, "field T1.TypedefsE4")...)
			errs = append(errs, typedefs.Validate_E4(ctx, op, fldPath, obj, oldObj, v)...)
			return
	...
	errs = append(errs,
		visit.Leaf(op, v, func(fldPath *field.Path, obj, oldObj *other.StringType) (errs field.ErrorList) {
	...
	// field T1.OtherInt
	errs = append(errs,
		visit.Leaf(op, v, func(fldPath *field.Path, obj, oldObj *other.IntType) (errs field.ErrorList) {
	...
	errs = append(errs,
		visit.Leaf(op, v, func(fldPath *field.Path, obj, oldObj *other.StructType) (errs field.ErrorList) {
	...
	errs = append(errs,
		visit.Leaf(op, v, func(fldPath *field.Path, obj, oldObj map[other.StringType]other.StructType) (errs field.ErrorList) {
