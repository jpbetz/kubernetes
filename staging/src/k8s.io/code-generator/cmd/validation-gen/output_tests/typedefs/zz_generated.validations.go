...
func Validate_E1(ctx context.Context, op operation.Operation, fldPath *field.Path, obj, oldObj *E1, v *visit.State) (errs field.ErrorList) {
	// type E1
...
func Validate_E2(ctx context.Context, op operation.Operation, fldPath *field.Path, obj, oldObj *E2, v *visit.State) (errs field.ErrorList) {
	// type E2
...
func Validate_E3(ctx context.Context, op operation.Operation, fldPath *field.Path, obj, oldObj *E3, v *visit.State) (errs field.ErrorList) {
	// type E3
...
func Validate_E4(ctx context.Context, op operation.Operation, fldPath *field.Path, obj, oldObj *E4, v *visit.State) (errs field.ErrorList) {
	// type E4
...
func Validate_T1(ctx context.Context, op operation.Operation, fldPath *field.Path, obj, oldObj *T1, v *visit.State) (errs field.ErrorList) {
	...
	// field T1.E1
	errs = append(errs,
		visit.Leaf(op, v, func(fldPath *field.Path, obj, oldObj *E1) (errs field.ErrorList) {
			errs = append(errs, validate.FixedResult(ctx, op, fldPath, obj, oldObj, false, "field T1.E1")...)
			errs = append(errs, Validate_E1(ctx, op, fldPath, obj, oldObj, v)...)
			return
	...
	// field T1.E2
	errs = append(errs,
		visit.Leaf(op, v, func(fldPath *field.Path, obj, oldObj *E2) (errs field.ErrorList) {
			errs = append(errs, validate.FixedResult(ctx, op, fldPath, obj, oldObj, false, "field T1.E2")...)
			errs = append(errs, Validate_E2(ctx, op, fldPath, obj, oldObj, v)...)
			return
	...
	// field T1.E3
	errs = append(errs,
		visit.Leaf(op, v, func(fldPath *field.Path, obj, oldObj *E3) (errs field.ErrorList) {
			errs = append(errs, validate.FixedResult(ctx, op, fldPath, obj, oldObj, false, "field T1.E3")...)
			errs = append(errs, Validate_E3(ctx, op, fldPath, obj, oldObj, v)...)
			return
	...
	// field T1.E4
	errs = append(errs,
		visit.Child(op, v, func(fldPath *field.Path, obj, oldObj *E4) (errs field.ErrorList) {
			errs = append(errs, validate.FixedResult(ctx, op, fldPath, obj, oldObj, false, "field T1.E4")...)
			errs = append(errs, Validate_E4(ctx, op, fldPath, obj, oldObj, v)...)
			return
	...
	// field T1.T2
	errs = append(errs,
		visit.Child(op, v, func(fldPath *field.Path, obj, oldObj *T2) (errs field.ErrorList) {
			errs = append(errs, validate.FixedResult(ctx, op, fldPath, obj, oldObj, false, "field T1.T2")...)
			errs = append(errs, Validate_T2(ctx, op, fldPath, obj, oldObj, v)...)
			return
...
func Validate_T2(ctx context.Context, op operation.Operation, fldPath *field.Path, obj, oldObj *T2, v *visit.State) (errs field.ErrorList) {
	// type T2
