...
type Args struct {
	...
	// RequireConversionHub indicates whether to enforce that exactly one version
	// of each API type is marked with the +k8s:conversion-hub tag.
	RequireConversionHub bool
...
func (args *Args) AddFlags(fs *pflag.FlagSet) {
	...
	fs.BoolVar(&args.RequireConversionHub, "require-conversion-hub", args.RequireConversionHub, "If true, enforce that exactly one version of each API type is marked as +k8s:conversion-hub. If false, allow 0 or 1.")
