...
var applyConfigObjectType = celtypes.NewObjectType("Object", traits.ContainerType)
...
// JSONPatchPathCondition contains the inputs needed to compile and evaluate a cel expression
// that returns a JSON patch path.
type JSONPatchPathCondition struct {
	Expression string
}

func (v *JSONPatchPathCondition) GetExpression() string {
	return v.Expression
}

func (v *JSONPatchPathCondition) ReturnTypes() []*celgo.Type {
