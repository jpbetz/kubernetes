...
func TestWithRecover(t *testing.T) {
	...
	testCases := []struct {
		name            string
		validateFn      func(context.Context, *runtime.Scheme, runtime.Object, runtime.Object, *validationConfig) field.ErrorList
	...
	for _, tc := range testCases {
		t.Run(tc.name, func(t *testing.T) {
			...
			gotErrs := wrapped(ctx, scheme, obj, nil, &validationConfig{opType: operation.Create, options: options, takeover: tc.takeoverEnabled})
...
func TestWithRecoverUpdate(t *testing.T) {
	...
	for _, tc := range testCases {
		t.Run(tc.name, func(t *testing.T) {
			...
			wrapped := panicSafeValidateFunc(tc.validateFn, tc.takeoverEnabled)
			gotErrs := wrapped(ctx, scheme, obj, oldObj, &validationConfig{opType: operation.Update, options: options, takeover: tc.takeoverEnabled})
