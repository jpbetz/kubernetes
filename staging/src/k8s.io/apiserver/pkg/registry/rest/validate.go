...
type ValidationConfig func(*validationConfig)
...
//
// Note that the result of the mapping contains no subresource part since the mapper is expected to
...
// conversion fails.
func ValidateDeclaratively(ctx context.Context, scheme *runtime.Scheme, obj runtime.Object, config ...ValidationConfig) field.ErrorList {
	o := &validationConfig{opType: operation.Create}
	for _, c := range config {
		c(o)
	}

	return panicSafeValidateFunc(validateDeclaratively, o.takeover)(ctx, scheme, obj, nil, o)
}
...
// is included if requestInfo is missing from the context or if version
// conversion fails.
func ValidateUpdateDeclaratively(ctx context.Context, scheme *runtime.Scheme, obj, oldObj runtime.Object, config ...ValidationConfig) field.ErrorList {
	o := &validationConfig{opType: operation.Update}
	for _, c := range config {
		c(o)
	}
	return panicSafeValidateFunc(validateDeclaratively, o.takeover)(ctx, scheme, obj, oldObj, o)
}

func validateDeclaratively(ctx context.Context, scheme *runtime.Scheme, obj, oldObj runtime.Object, o *validationConfig) field.ErrorList {
...
func panicSafeValidateFunc(
	validateUpdateFunc func(ctx context.Context, scheme *runtime.Scheme, obj, oldObj runtime.Object, o *validationConfig) field.ErrorList,
	takeover bool,
) func(ctx context.Context, scheme *runtime.Scheme, obj, oldObj runtime.Object, o *validationConfig) field.ErrorList {
	return func(ctx context.Context, scheme *runtime.Scheme, obj, oldObj runtime.Object, o *validationConfig) (errs field.ErrorList) {
