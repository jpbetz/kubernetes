...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*admissionregistrationv1alpha1.JSONPatchOperation)(nil), (*admissionregistration.JSONPatchOperation)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha1_JSONPatchOperation_To_admissionregistration_JSONPatchOperation(a.(*admissionregistrationv1alpha1.JSONPatchOperation), b.(*admissionregistration.JSONPatchOperation), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*admissionregistration.JSONPatchOperation)(nil), (*admissionregistrationv1alpha1.JSONPatchOperation)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_admissionregistration_JSONPatchOperation_To_v1alpha1_JSONPatchOperation(a.(*admissionregistration.JSONPatchOperation), b.(*admissionregistrationv1alpha1.JSONPatchOperation), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1alpha1_JSONPatchOperation_To_admissionregistration_JSONPatchOperation(in *admissionregistrationv1alpha1.JSONPatchOperation, out *admissionregistration.JSONPatchOperation, s conversion.Scope) error {
	out.Op = admissionregistration.JSONPatchOperationType(in.Op)
	out.PathExpression = in.PathExpression
	out.FromExpression = in.FromExpression
	out.ValueExpression = in.ValueExpression
	return nil
}

// Convert_v1alpha1_JSONPatchOperation_To_admissionregistration_JSONPatchOperation is an autogenerated conversion function.
func Convert_v1alpha1_JSONPatchOperation_To_admissionregistration_JSONPatchOperation(in *admissionregistrationv1alpha1.JSONPatchOperation, out *admissionregistration.JSONPatchOperation, s conversion.Scope) error {
	return autoConvert_v1alpha1_JSONPatchOperation_To_admissionregistration_JSONPatchOperation(in, out, s)
}

func autoConvert_admissionregistration_JSONPatchOperation_To_v1alpha1_JSONPatchOperation(in *admissionregistration.JSONPatchOperation, out *admissionregistrationv1alpha1.JSONPatchOperation, s conversion.Scope) error {
	out.Op = admissionregistrationv1alpha1.JSONPatchOperationType(in.Op)
	out.PathExpression = in.PathExpression
	out.FromExpression = in.FromExpression
	out.ValueExpression = in.ValueExpression
	return nil
...
// Convert_admissionregistration_JSONPatchOperation_To_v1alpha1_JSONPatchOperation is an autogenerated conversion function.
func Convert_admissionregistration_JSONPatchOperation_To_v1alpha1_JSONPatchOperation(in *admissionregistration.JSONPatchOperation, out *admissionregistrationv1alpha1.JSONPatchOperation, s conversion.Scope) error {
	return autoConvert_admissionregistration_JSONPatchOperation_To_v1alpha1_JSONPatchOperation(in, out, s)
}
