...
var GVRToStorageVersionHash = map[string]string{
	...
	// TODO cici37: update the hash
	"admissionregistration.k8s.io/v1alpha1/mutatingwebhookconfigurations":   "Sqi0GUgDaX0=",
	"admissionregistration.k8s.io/v1alpha1/validatingwebhookconfigurations": "B0wHjQmsGNk=",
	"admissionregistration.k8s.io/v1alpha1/validatingadmissionpolicy":       "Sqi0GUgDaX0=",
	"admissionregistration.k8s.io/v1alpha1/policybingding":                  "B0wHjQmsGNk=",
