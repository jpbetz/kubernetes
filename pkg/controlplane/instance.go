...
func (m *Instance) InstallAPIs(apiResourceConfigSource serverstorage.APIResourceConfigSource, restOptionsGetter generic.RESTOptionsGetter, restStorageProviders ...RESTStorageProvider) error {
	...
	resourceExpirationEvaluator, err := genericapiserver.NewResourceExpirationEvaluator(m.GenericAPIServer.EmulationVersion)
	if err != nil {
		return err
	}
...
func DefaultAPIResourceConfigSource(emulationVersion string, registry serverstorage.GroupVersionRegistry) *serverstorage.ResourceConfig {
	ret := serverstorage.NewResourceConfig(emulationVersion, registry)
