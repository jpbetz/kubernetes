...
import (
	...
	policybindingstorage "k8s.io/kubernetes/pkg/registry/admissionregistration/policybinding/storage"
...
func (p RESTStorageProvider) v1alpha1Storage(apiResourceConfigSource serverstorage.APIResourceConfigSource, restOptionsGetter generic.RESTOptionsGetter) (map[string]rest.Storage, error) {
	...
	// policybinding
	if resource := "policybinding"; apiResourceConfigSource.ResourceEnabled(admissionregistrationv1alpha1.SchemeGroupVersion.WithResource(resource)) {
