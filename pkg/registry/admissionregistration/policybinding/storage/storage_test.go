...
func TestUpdate(t *testing.T) {
	...
	test.TestUpdate(
		...
		func(obj runtime.Object) runtime.Object {
			object := obj.(*admissionregistration.PolicyBinding)
...
func validPolicyBinding() *admissionregistration.PolicyBinding {
	return &admissionregistration.PolicyBinding{
		ObjectMeta: metav1.ObjectMeta{
			Name: "foo",
		},
		Spec: admissionregistration.PolicyBindingSpec{
...
func newPolicyBinding(name string) *admissionregistration.PolicyBinding {
	return &admissionregistration.PolicyBinding{
		ObjectMeta: metav1.ObjectMeta{
			Name:   name,
