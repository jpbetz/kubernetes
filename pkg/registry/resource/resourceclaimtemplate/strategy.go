...
// DeclarativeRequestConfig supplies the same path-normalization rules used
...
func (*resourceClaimTemplateStrategy) DeclarativeRequestConfig(ctx context.Context, obj, oldObj runtime.Object) rest.DeclarativeRequestConfig {
