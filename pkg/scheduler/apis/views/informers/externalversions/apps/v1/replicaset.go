...
import (
	...
	versioned "k8s.io/kubernetes/pkg/scheduler/apis/views/clientset/versioned"
	internalinterfaces "k8s.io/kubernetes/pkg/scheduler/apis/views/informers/externalversions/internalinterfaces"
	appsv1 "k8s.io/kubernetes/pkg/scheduler/apis/views/listers/apps/v1"
)
...
// Always prefer using an informer factory to get a shared informer instead of getting an independent
// one. This reduces memory footprint and number of connections to the server.
func NewReplicaSetInformerWithOptions(client versioned.Interface, namespace string, options internalinterfaces.InformerOptions) cache.SharedIndexInformer {
...
func (f *replicaSetInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&viewsappsv1.ReplicaSet{}, f.defaultInformer)
}
